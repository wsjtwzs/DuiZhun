...
+ (void) deleteUserInfo
{
    ...
    [defaults setObject:nil forKey:USER_TOKEN];
...
{
    CGSize  size = [GlobalConfig getAdjustHeightOfContent:message width:210 fontSize:14];
    UIView *view = [[UIView alloc] initWithFrame:CGRectMake((SCREENWIDTH - 210)/2, (SCREENHEIGHT - size.height - 10)/2 - STATEHEIGHT - NAVHEIGHT, 210, (size.height + 10))];

    view.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.5];
    view.layer.shadowColor = BLACKCOLOR.CGColor;
    view.layer.shadowOpacity = 0.8;
    
    UILabel *label = [GlobalConfig createLabelWithFrame:CGRectMake(0, 0, CGRectGetWidth(view.frame), CGRectGetHeight(view.frame)) Text:@"" FontSize:14 textColor:WHITECOLOR];
    label.textColor = WHITECOLOR;
