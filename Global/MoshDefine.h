...
#define FRAME_MIDDLE    CGRectMake(0, 20, SCREENWIDTH, SCREENHEIGHT)
#define FRAME_RIGHT     CGRectMake(SCREENWIDTH, 20, SCREENWIDTH, SCREENHEIGHT)
#define FRAME_LEFT      CGRectMake(-SCREENWIDTH, 20, SCREENWIDTH, SCREENHEIGHT)
